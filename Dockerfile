...
RUN apt-get -y update && apt-get install -y build-essential cmake httpie libsndfile1
RUN apt-get -y update && apt-get install -y python3-dev python3-pip python3-setuptools python3-wheel python3-cffi 
RUN apt-get -y update && apt-get install -y  libcairo2 libpango-1.0-0 libpangocairo-1.0-0 
RUN apt-get -y update && apt-get install -y  libgdk-pixbuf2.0-0 libffi-dev shared-mime-info
RUN apt-get -y update && apt-get -y install python3-tk graphviz
